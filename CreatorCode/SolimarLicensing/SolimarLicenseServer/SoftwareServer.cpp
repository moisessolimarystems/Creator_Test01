...
HRESULT SoftwareServer::EnterSoftwareLicArchive(VARIANT vtLicArchive)
{
	...
	try
	{
		...
		if(pSoftwareLicMgr == NULL)
		{
			...
			// Hide the string so it doesn't appear in the strings of the image - "Solimar Systems\\Solimar Licensing\\Data\\"
			BYTE fileLocByte[] = {
				...
				0x6e, 0x00, 0x67, 0x00, 0x5c, 0x00, 0x5c, 0x00, 0x44, 0x00, 0x61, 0x00, 0x74, 0x00, 0x61, 0x00, 0x5c, 0x00, 0x5c, 0x00, 0x00, 0x00
			};
