...
namespace KeyReaderGUI
{
   ...
   private: System::Windows::Forms::MenuItem *  ContactInfoMenuItem;
   ...
   //Event Handler methods
	...
	private:
		...
		void InitializeComponent(void)
		{
         ...
         this->ContactInfoMenuItem = new System::Windows::Forms::MenuItem();
         ...
         __mcTemp__5[1] = this->ContactInfoMenuItem;
         ...
         this->AboutSolimar->Text = S"About Solimar";
         // 
         // ContactInfoMenuItem
         // 
         this->ContactInfoMenuItem->Index = 1;
         this->ContactInfoMenuItem->Text = S"Contact Solimar";
         // 
         // ModuleLicensePanel
         // 
		...
		AboutBoxForm* TheAboutBox;
		ContactInfo* TheContactInfoPage;
