namespace SolimarLicenseDiagnosticDataViewer
{
	partial class Lic_SystemInfoAttribs_DisplayForm
	{
		...
		private void InitializeComponent()
		{
            ...
            this.columnHeader1});
			this.computerNameListView.ContextMenuStrip = this.contextMenuStrip1;
			...
			this.computerNameListView.KeyDown += new System.Windows.Forms.KeyEventHandler(this.general_KeyDown);
			// 
			// columnHeader1
			// 
            ...
            this.columnHeader2});
			this.macAddressListView.ContextMenuStrip = this.contextMenuStrip1;
			...
			this.macAddressListView.KeyDown += new System.Windows.Forms.KeyEventHandler(this.general_KeyDown);
			// 
			// columnHeader2
			// 
            ...
            this.columnHeader3});
			this.biosSerialNumberListView.ContextMenuStrip = this.contextMenuStrip1;
			...
			this.biosSerialNumberListView.KeyDown += new System.Windows.Forms.KeyEventHandler(this.general_KeyDown);
			// 
			// columnHeader3
			// 
