...
/** Creates a multidimensional array of 
  ...
  */
HRESULT MultidimensionalSafeArray::CreateMultidimensionalSafearray(VARIANT* array, DimensionsType &dimensions)
{
	HRESULT hr;
	...
	else
	{
		...
		if (!pDataSA) {
			//TRACE(" MultidimensionalSafeArray::CreateMultidimensionalSafearray SafeArrayCreateVector failed");
		...
		if (FAILED(hr)) {
			//TRACEhr(hr, " MultidimensionalSafeArray::CreateMultidimensionalSafearray SafeArrayAccessData failed");
...
/** Provides access to an element or array in the 
  ...
  */
HRESULT MultidimensionalSafeArray::AccessMultidimensionalSafearray(VARIANT* array, DimensionsType &indices, VARIANT** element)
{
	HRESULT hr;
...
/** Provides releases the element obtained with a call to Access...
  ...
  */
HRESULT MultidimensionalSafeArray::UnaccessMultidimensionalSafearray(VARIANT* array, DimensionsType &indices)
{
	HRESULT hr;
...
HRESULT MultidimensionalSafeArray::DeleteMultidimensionalSafearray(VARIANT* array)
{
	HRESULT hr = VariantClear(array);
...
HRESULT MultidimensionalSafeArray::SizeofMultidimensionalSafearray(VARIANT* array, DimensionsType &indices)
{
	HRESULT hr=S_OK;
	VARIANT* pVariant;
...
HRESULT MultidimensionalSafeArray::CreateSafeArrayFromFile(VARIANT* pvArray, BSTR path)
{
	void *pData;
...
HRESULT MultidimensionalSafeArray::CreateSafeArrayFromBuffer(VARIANT* pvArray, void* buffer, unsigned int buffersize)
{
