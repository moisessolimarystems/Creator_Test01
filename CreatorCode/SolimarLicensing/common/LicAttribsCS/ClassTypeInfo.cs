	...
	namespace Licensing
	{
		public class ClassTypeInfo
		{
			...
			public ClassTypeInfo()
			{
				...
				((ClassInfoBase)map_class_base["S_ElInA"]).attribs["log"] = new AttribInfo("log","","");
				((ClassInfoBase)map_class_base["S_ElInA"]).attribs["machineName"] = new AttribInfo("machineName","","");
				((ClassInfoBase)map_class_base["S_ElInA"]).attribs["entryList"] = new AttribInfo("entryList","","");
				((ClassInfoBase)map_class_base["S_ElInA"]).attribs["maximumKilobytes"] = new AttribInfo("maximumKilobytes","","");
				((ClassInfoBase)map_class_base["S_ElInA"]).attribs["source"] = new AttribInfo("source","","");
