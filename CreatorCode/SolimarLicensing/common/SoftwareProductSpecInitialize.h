...
void InititalizeProduct110()
{
	...
	pTmpProdSpec->productLabel = std::wstring(L"Test/Dev/DR Solimar Indexing Tools");
...
void InititalizeProduct25()
{
	...
	//
	// ProdID:25, ProdName: SPDE Essentials
	...
	pTmpProdSpec->productName = std::wstring(L"SPDE Essentials");

	Lic_PackageAttribs::Lic_ModuleSoftwareSpecAttribs* pTmpModSpec;
	
	pTmpProdSpec->moduleSpecMap->insert(Lic_PackageAttribs::Lic_ProductSoftwareSpecAttribs::TMap_Lic_ModuleSoftwareSpecAttribsMap::value_type(113, Lic_PackageAttribs::Lic_ModuleSoftwareSpecAttribs()));
	pTmpModSpec = &((pTmpProdSpec->moduleSpecMap->find(113))->second);
	pTmpModSpec->moduleID = 113;
	pTmpModSpec->moduleName = std::wstring(L"SLS Job Ticket Manager");
	...
	pTmpModSpec->moduleVersionIntroduced_SubMinor = 92;
	...
	pTmpModSpec->moduleName = std::wstring(L"ReadyPDF Optimization");
	pTmpModSpec->modUnlimitedValue = 1;
	pTmpModSpec->moduleTrialLicense = 1;
	
	pTmpProdSpec->moduleSpecMap->insert(Lic_PackageAttribs::Lic_ProductSoftwareSpecAttribs::TMap_Lic_ModuleSoftwareSpecAttribsMap::value_type(64, Lic_PackageAttribs::Lic_ModuleSoftwareSpecAttribs()));
	pTmpModSpec = &((pTmpProdSpec->moduleSpecMap->find(64))->second);
	pTmpModSpec->moduleID = 64;
	pTmpModSpec->moduleName = std::wstring(L"Dispatch File Input");
	pTmpModSpec->modUnlimitedValue = 1;
	pTmpModSpec->moduleTrialLicense = 1;
	pTmpModSpec->moduleDefaultLicense = 1;
	pTmpModSpec->moduleVersionIntroduced_SubMinor = 87;
	
	pTmpProdSpec->moduleSpecMap->insert(Lic_PackageAttribs::Lic_ProductSoftwareSpecAttribs::TMap_Lic_ModuleSoftwareSpecAttribsMap::value_type(65, Lic_PackageAttribs::Lic_ModuleSoftwareSpecAttribs()));
	pTmpModSpec = &((pTmpProdSpec->moduleSpecMap->find(65))->second);
	pTmpModSpec->moduleID = 65;
	pTmpModSpec->moduleName = std::wstring(L"Dispatch Spooler Output");
	pTmpModSpec->modUnlimitedValue = 1;
	pTmpModSpec->moduleTrialLicense = 1;
	pTmpModSpec->moduleDefaultLicense = 1;
	pTmpModSpec->moduleVersionIntroduced_SubMinor = 87;
	...
	pTmpModSpec->moduleVersionIntroduced_Major = 9;
	pTmpModSpec->moduleVersionIntroduced_Minor = 2;
	pTmpModSpec->moduleVersionIntroduced_SubMinor = 91;
	...
	pTmpProdSpec->moduleSpecMap->insert(Lic_PackageAttribs::Lic_ProductSoftwareSpecAttribs::TMap_Lic_ModuleSoftwareSpecAttribsMap::value_type(109, Lic_PackageAttribs::Lic_ModuleSoftwareSpecAttribs()));
	pTmpModSpec = &((pTmpProdSpec->moduleSpecMap->find(109))->second);
	pTmpModSpec->moduleID = 109;
	pTmpModSpec->moduleName = std::wstring(L"SLS Queueing");
	pTmpModSpec->modUnlimitedValue = 1;
	pTmpModSpec->moduleTrialLicense = 1;
	...
	pTmpModSpec->moduleVersionIntroduced_SubMinor = 98;
	...
	pTmpProdSpec->moduleSpecMap->insert(Lic_PackageAttribs::Lic_ProductSoftwareSpecAttribs::TMap_Lic_ModuleSoftwareSpecAttribsMap::value_type(59, Lic_PackageAttribs::Lic_ModuleSoftwareSpecAttribs()));
	pTmpModSpec = &((pTmpProdSpec->moduleSpecMap->find(59))->second);
	pTmpModSpec->moduleID = 59;
	pTmpModSpec->moduleName = std::wstring(L"Emulation Selector");
	pTmpModSpec->modUnlimitedValue = 1;
	pTmpModSpec->moduleTrialLicense = 1;
	pTmpModSpec->moduleDefaultLicense = 1;
	...
	pTmpProdSpec->moduleSpecMap->insert(Lic_PackageAttribs::Lic_ProductSoftwareSpecAttribs::TMap_Lic_ModuleSoftwareSpecAttribsMap::value_type(116, Lic_PackageAttribs::Lic_ModuleSoftwareSpecAttribs()));
	pTmpModSpec = &((pTmpProdSpec->moduleSpecMap->find(116))->second);
	pTmpModSpec->moduleID = 116;
...
void InititalizeProduct22()
{
	...
	//
	// ProdID:22, ProdName: Solimar Utilities
	...
	pTmpProdSpec->productName = std::wstring(L"Solimar Utilities");
	pTmpProdSpec->productLicType = Lic_PackageAttribs::Lic_ProductSoftwareSpecAttribs::pltClient;
	...
	pTmpModSpec = &((pTmpProdSpec->moduleSpecMap->find(0))->second);
	pTmpModSpec->moduleID = 0;
	pTmpModSpec->moduleName = std::wstring(L"Solimar Compiler");
	pTmpModSpec->modUnlimitedValue = 1;
	pTmpModSpec->moduleTrialLicense = 1;
}
...
void InititalizeProduct23()
{
	...
	pTmpModSpec->moduleVersionIntroduced_Minor = 2;
	pTmpModSpec->moduleVersionIntroduced_SubMinor = 52;
	...
	pTmpModSpec->moduleName = std::wstring(L"N-Up");
	pTmpModSpec->modUnlimitedValue = 1;
	pTmpModSpec->moduleTrialLicense = 1;
	pTmpModSpec->moduleVersionIntroduced_SubMinor = 107;
	...
	pTmpModSpec->moduleName = std::wstring(L"Piece Level Tracking");
	pTmpModSpec->modUnlimitedValue = 1;
	pTmpModSpec->moduleTrialLicense = 1;
	pTmpModSpec->moduleVersionIntroduced_Major = 4;
	pTmpModSpec->moduleVersionIntroduced_Minor = 3;
	pTmpModSpec->moduleVersionIntroduced_SubMinor = 67;
...
void InititalizeProduct8()
{
	...
	pTmpProdSpec->moduleSpecMap->insert(Lic_PackageAttribs::Lic_ProductSoftwareSpecAttribs::TMap_Lic_ModuleSoftwareSpecAttribsMap::value_type(134, Lic_PackageAttribs::Lic_ModuleSoftwareSpecAttribs()));
	pTmpModSpec = &((pTmpProdSpec->moduleSpecMap->find(134))->second);
	pTmpModSpec->moduleID = 134;
	pTmpModSpec->moduleName = std::wstring(L"Tiered Storage");
	pTmpModSpec->modUnlimitedValue = 1;
	pTmpModSpec->moduleTrialLicense = 1;
	pTmpModSpec->moduleVersionIntroduced_Major = 3;
	pTmpModSpec->moduleVersionIntroduced_Minor = 6;
	pTmpModSpec->moduleVersionIntroduced_SubMinor = 22;
...
void InititalizeProduct125()
{
	Lic_PackageAttribs::Lic_ProductSoftwareSpecAttribs* pTmpProdSpec;
	
	//
	// ProdID:125, ProdName: Test/Dev/DR SPDE Essentials
	softwareSpec.productSpecMap->insert(Lic_PackageAttribs::Lic_SoftwareSpecAttribs::TMap_Lic_ProductSoftwareSpecAttribsMap::value_type(125, Lic_PackageAttribs::Lic_ProductSoftwareSpecAttribs()));
	pTmpProdSpec = &((softwareSpec.productSpecMap->find(125))->second);
...
void InititalizeProduct10()
{
	...
	pTmpProdSpec->productLabel = std::wstring(L"Solimar Indexing Tools");
...
void InititalizeProduct12()
{
	...
	pTmpModSpec->moduleName = std::wstring(L"Page Boxes");
	pTmpModSpec->modUnlimitedValue = 1;
	pTmpModSpec->moduleTrialLicense = 1;
	pTmpModSpec->moduleDefaultLicense = 1;
	pTmpModSpec->moduleVersionIntroduced_Major = 4;
	pTmpModSpec->moduleVersionIntroduced_Minor = 5;
	pTmpModSpec->moduleVersionIntroduced_SubMinor = 114;
	...
	pTmpModSpec->moduleVersionIntroduced_Major = 4;
	pTmpModSpec->moduleVersionIntroduced_Minor = 5;
	pTmpModSpec->moduleVersionIntroduced_SubMinor = 99;
...
void InititalizeProduct14()
{
	...
	pTmpModSpec->moduleVersionIntroduced_Minor = 3;
	pTmpModSpec->moduleVersionIntroduced_SubMinor = 42;
	...
	pTmpProdSpec->moduleSpecMap->insert(Lic_PackageAttribs::Lic_ProductSoftwareSpecAttribs::TMap_Lic_ModuleSoftwareSpecAttribsMap::value_type(55, Lic_PackageAttribs::Lic_ModuleSoftwareSpecAttribs()));
	pTmpModSpec = &((pTmpProdSpec->moduleSpecMap->find(55))->second);
	pTmpModSpec->moduleID = 55;
	pTmpModSpec->moduleName = std::wstring(L"File IO Manager");
	pTmpModSpec->modUnlimitedValue = 1;
	pTmpModSpec->moduleTrialLicense = 1;
	pTmpModSpec->moduleVersionIntroduced_Major = 8;
	pTmpModSpec->moduleVersionIntroduced_Minor = 1;
	pTmpModSpec->moduleVersionIntroduced_SubMinor = 23;
	...
	pTmpModSpec = &((pTmpProdSpec->moduleSpecMap->find(56))->second);
	pTmpModSpec->moduleID = 56;
	pTmpModSpec->moduleName = std::wstring(L"AFPDS::AFPDS");
	pTmpModSpec->modUnlimitedValue = 1;
	pTmpModSpec->moduleTrialLicense = 1;
	pTmpModSpec->moduleVersionIntroduced_Major = 8;
	pTmpModSpec->moduleVersionIntroduced_Minor = 0;
	pTmpModSpec->moduleVersionIntroduced_SubMinor = 24;
	...
	pTmpModSpec->moduleVersionIntroduced_Major = 7;
	pTmpModSpec->moduleVersionIntroduced_Minor = 5;
	pTmpModSpec->moduleVersionIntroduced_SubMinor = 13;
	...
	pTmpModSpec->moduleVersionIntroduced_Major = 7;
	pTmpModSpec->moduleVersionIntroduced_Minor = 5;
	pTmpModSpec->moduleVersionIntroduced_SubMinor = 14;
	...
	pTmpProdSpec->moduleSpecMap->insert(Lic_PackageAttribs::Lic_ProductSoftwareSpecAttribs::TMap_Lic_ModuleSoftwareSpecAttribsMap::value_type(60, Lic_PackageAttribs::Lic_ModuleSoftwareSpecAttribs()));
	pTmpModSpec = &((pTmpProdSpec->moduleSpecMap->find(60))->second);
	pTmpModSpec->moduleID = 60;
	pTmpModSpec->moduleName = std::wstring(L"IPDS::IPDS");
	pTmpModSpec->modUnlimitedValue = 1;
	pTmpModSpec->moduleTrialLicense = 1;
	pTmpModSpec->moduleVersionIntroduced_Major = 8;
	pTmpModSpec->moduleVersionIntroduced_Minor = 3;
	pTmpModSpec->moduleVersionIntroduced_SubMinor = 44;
	
	pTmpProdSpec->moduleSpecMap->insert(Lic_PackageAttribs::Lic_ProductSoftwareSpecAttribs::TMap_Lic_ModuleSoftwareSpecAttribsMap::value_type(61, Lic_PackageAttribs::Lic_ModuleSoftwareSpecAttribs()));
	pTmpModSpec = &((pTmpProdSpec->moduleSpecMap->find(61))->second);
	pTmpModSpec->moduleID = 61;
	pTmpModSpec->moduleName = std::wstring(L"PDF::IPDS(OC)");
	pTmpModSpec->modUnlimitedValue = 1;
	pTmpModSpec->moduleTrialLicense = 1;
	pTmpModSpec->moduleVersionIntroduced_Major = 8;
	pTmpModSpec->moduleVersionIntroduced_Minor = 3;
	...
	pTmpModSpec->moduleVersionIntroduced_Major = 8;
	pTmpModSpec->moduleVersionIntroduced_Minor = 4;
	pTmpModSpec->moduleVersionIntroduced_SubMinor = 62;
	...
	pTmpModSpec->moduleVersionIntroduced_Major = 8;
	pTmpModSpec->moduleVersionIntroduced_Minor = 1;
	pTmpModSpec->moduleVersionIntroduced_SubMinor = 34;
...
void InititalizeProduct16()
{
	...
	pTmpModSpec = &((pTmpProdSpec->moduleSpecMap->find(7))->second);
	pTmpModSpec->moduleID = 7;
	pTmpModSpec->moduleName = std::wstring(L"Proof and Approval");
	pTmpModSpec->modUnlimitedValue = 1;
	pTmpModSpec->moduleTrialLicense = 1;
	pTmpModSpec->moduleVersionIntroduced_Major = 2;
	pTmpModSpec->moduleVersionIntroduced_Minor = 4;
	pTmpModSpec->moduleVersionIntroduced_SubMinor = 80;
	...
	pTmpModSpec = &((pTmpProdSpec->moduleSpecMap->find(9))->second);
	pTmpModSpec->moduleID = 9;
	pTmpModSpec->moduleName = std::wstring(L"Duplicate File Checking");
	pTmpModSpec->modUnlimitedValue = 1;
	pTmpModSpec->moduleTrialLicense = 1;
	pTmpModSpec->moduleVersionIntroduced_Major = 2;
	pTmpModSpec->moduleVersionIntroduced_Minor = 5;
	pTmpModSpec->moduleVersionIntroduced_SubMinor = 88;
...
void InititalizeProduct122()
{
	Lic_PackageAttribs::Lic_ProductSoftwareSpecAttribs* pTmpProdSpec;
	
	//
	// ProdID:122, ProdName: Test/Dev/DR Solimar Utilities
	softwareSpec.productSpecMap->insert(Lic_PackageAttribs::Lic_SoftwareSpecAttribs::TMap_Lic_ProductSoftwareSpecAttribsMap::value_type(122, Lic_PackageAttribs::Lic_ProductSoftwareSpecAttribs()));
	pTmpProdSpec = &((softwareSpec.productSpecMap->find(122))->second);
