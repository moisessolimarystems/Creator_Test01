// ISolimarLicenseMgr.h : Declaration of the ISolimarLicenseMgr
//
...
const GUID CLSID_CSolimarLicenseMgr = {0x986A969C,0xF4C2,0x4EB7,{0x85,0xE6,0xF0,0x49,0x20,0x1A,0xEB,0xB9}}; // CR.32662; added.
