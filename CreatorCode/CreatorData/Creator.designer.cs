...
namespace CreatorData
{
    ...
    partial void OnTypeIDChanged();
		...
		[Column(Storage="_TypeID", DbType="TinyInt NOT NULL", UpdateCheck=UpdateCheck.Never)]
		[DataMember(Order=17)]
		public int TypeID
		{
			get
		...
		[Association(Name="ProductLicenseTable_ProductLicenseType", Storage="_ProductLicenseTypes", ThisKey="TypeID", OtherKey="ID")]
    ...
    partial void OnProductLicenseIDChanged();
		...
		[Column(Storage="_Value", DbType="Int NOT NULL", UpdateCheck=UpdateCheck.Never)]
		[DataMember(Order=3)]
		public int Value
		{
			get
	...
	[Table(Name="dbo.ProductLicenseType")]
	[DataContract()]
    ...
    partial void OnTypeChanged();
		...
		[Column(Storage="_Type", DbType="VarChar(50) NOT NULL", CanBeNull=false, UpdateCheck=UpdateCheck.Never)]
		[DataMember(Order=2)]
		public string Type
		{
			get
		...
		[Association(Name="ProductLicenseTable_ProductLicenseType", Storage="_ProductLicenseTable", ThisKey="ID", OtherKey="TypeID", IsForeignKey=true)]
		public ProductLicenseTable ProductLicenseTable
		{
			get
			{
