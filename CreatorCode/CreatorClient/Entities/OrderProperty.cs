...
namespace Client.Creator
{
    ...
    public class OrderProperty
    {
        ...
        public OrderProperty(OrderTable orderData, ProductProperty product, PermissionsTable permissions)
        {
        ...
        [Category("Order"), PropertyOrder(2)]
        [DisplayName("Status")]
        [ReadOnly(true)]
        ...
        [Category("Order"), PropertyOrder(3)]
        [DisplayName("Parent Order Number")]
        [ReadOnly(true)]
        ...
        [Category("Order"), PropertyOrder(4)]
        ...
        [Category("Order"), PropertyOrder(5)]
