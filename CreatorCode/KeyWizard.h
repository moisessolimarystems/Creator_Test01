...
private:
        ...
        void SetSSEMembers(){}
        bool hasModuleLicenses(){if(key_record->pkey->productId==SPD_PRODUCT||key_record->pkey->productId==CONNECT_PRODUCT||key_record->pkey->productId==QUANTUM_PRODUCT||key_record->pkey->productId==ICONVERT_PRODUCT||key_record->pkey->productId==SOLSCRIPT_PRODUCT||key_record->pkey->productId==SDX_DESIGNER_PRODUCT||key_record->pkey->productId==PDF_UTILITY)return true;else return false;}
