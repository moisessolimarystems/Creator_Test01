...
set INSTALLPROJECT=E:\Creator\CREATO~2\Creator.ipr
set CURRENTBUILD=Creator
...
set INCLUDESCRIPT=E:\Creator\CREATO~2\Script Files
...
set RULFILES=E:\Creator\CREATO~2\Script Files\setup.rul
